...
Rectangle {
    ...
    Text {
        ...
        visible: if (mainWindow.loginFlag) {
                     true
                 } else {
                     false
                 }
    ...
    Image {
        id: emailIcon
        source: "./图片/Icon图片/email_icon.png"
        anchors.right: minTitleBar.left
    ...
    Image {
        id: setIcon
        source: "./图片/Icon图片/set_icon.png"
        anchors.right: emailIcon.left
        anchors.rightMargin: 20
        anchors.top: parent.top
        anchors.topMargin: 10
        width: 20
        ...
        MouseArea {
            ...
            onClicked: {
                if (mouse.button === Qt.LeftButton && window.visible == false) {
                    window.visible = true
                    menu.open()
